...
namespace ModularRPCs.Test.SourceGen
{
    ...
    public partial class SendRawTestsWithId
    {
        ...
        {
            int skipSize = ProxyGenerator.Instance.CalculateOverheadSize(typeof(SendRawTestsNoId.TestClass).GetMethod(name, BindingFlags.Public | BindingFlags.Instance)!.MethodHandle, cl, out _);
        ...
        public partial class TestClass : IRpcObject<string>
        {
            ...
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeStreamToByteArray(Stream stream, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeByteReaderToByteArray(ByteReader reader, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeByteWriterToByteArray(ByteWriter writer, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeArraySegmentToByteArray(ArraySegment<byte> bytes, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeMemoryToByteArray(Memory<byte> bytes, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeReadOnlyMemoryToByteArray(ReadOnlyMemory<byte> bytes, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeSpanToByteArray(Span<byte> bytes, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeReadOnlySpanToByteArray(ReadOnlySpan<byte> bytes, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public unsafe partial RpcTask InvokePointerToByteArray(byte* bytes, int byteCt, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeEnumerableWithCountToByteArray(IEnumerable<byte> bytes, int byteCt, bool canTakeOwnership);
        
            [RpcSend(nameof(ReceiveByteArray), Raw = true)]
            public partial RpcTask InvokeEnumerableWithoutCountToByteArray(IEnumerable<byte> bytes, bool canTakeOwnership);
