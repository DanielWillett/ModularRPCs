...
namespace ModularRPCs.Test.SourceGen
{
    ...
    public partial class RpcSerializableTypes
    {
        ...
        private static readonly IEnumerable<RpcSerializable>[] RpcSerializableCollectionTypes =
            new IEnumerable<RpcSerializable>[]
            {
                new RpcSerializable[]
                {
        ...
        private static readonly IEnumerable<FixedRpcSerializable>[] FixedRpcSerializableCollectionTypes =
            new IEnumerable<FixedRpcSerializable>[]
            {
        ...
        public partial class TestClass
        {
            ...
            public partial RpcTask<RpcSerializable> InvokeFromClient(int param1, RpcSerializable obj, int param2);

            [RpcSend(nameof(Receive)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<RpcSerializable> InvokeFromServer(int param1, RpcSerializable obj, int param2, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveArray)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<RpcSerializable[]> InvokeFromClient(int param1, IEnumerable<RpcSerializable> obj, int param2);

            [RpcSend(nameof(ReceiveArray)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<RpcSerializable[]> InvokeFromServer(int param1, IEnumerable<RpcSerializable> obj, int param2, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<FixedRpcSerializable> InvokeFromClient(int param1, FixedRpcSerializable obj, int param2);

            [RpcSend(nameof(FixedReceive)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<FixedRpcSerializable> InvokeFromServer(int param1, FixedRpcSerializable obj, int param2, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(FixedReceiveArray)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<FixedRpcSerializable[]> InvokeFromClient(int param1, IEnumerable<FixedRpcSerializable> obj, int param2);

            [RpcSend(nameof(FixedReceiveArray)), RpcTimeout(15 * Timeouts.Seconds)]
            public partial RpcTask<FixedRpcSerializable[]> InvokeFromServer(int param1, IEnumerable<FixedRpcSerializable> obj, int param2, IModularRpcRemoteConnection connection);
