...
namespace ModularRPCs.Test.SourceGen
{
    ...
    public partial class SendToMultipleClients
    {
        ...
        public partial class TestClass
        {
            ...
            public partial RpcTask InvokeFromServer(IEnumerable<IModularRpcRemoteConnection> connections);
            
            [RpcSend(nameof(Receive)), RpcFireAndForget]
            public partial RpcTask InvokeFromServerClass(List<IModularRpcRemoteConnection> connections);
            
            [RpcSend(nameof(Receive)), RpcFireAndForget]
            public partial RpcTask InvokeFromServerStruct(ArraySegment<IModularRpcRemoteConnection> connections);
