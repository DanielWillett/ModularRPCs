...
namespace ModularRPCs.Test.SourceGen
{
    ...
    public partial class ReturnTypeNullableValue
    {
        ...
        public partial class TestClass
        {
            ...
            public partial RpcTask<int?> InvokeFromClient(bool useNull);

            [RpcSend(nameof(Receive))]
            public partial RpcTask<int?> InvokeFromServer(bool useNull, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveTask))]
            public partial RpcTask<int?> InvokeTaskFromClient(bool useNull);

            [RpcSend(nameof(ReceiveTask))]
            public partial RpcTask<int?> InvokeTaskFromServer(bool useNull, IModularRpcRemoteConnection connection);
