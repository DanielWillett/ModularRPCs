...
namespace ModularRPCs.Test.SourceGen
{
    ...
    public partial class ReturnTypeSerializableCollection
    {
        ...
        public partial class TestClass
        {
            ...
            public partial RpcTask<SerializableTypeClassFixed[]> InvokeFromClientSerializableClassArrayFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassArrayFixed))]
            public partial RpcTask<SerializableTypeClassFixed[]> InvokeFromServerSerializableClassArrayFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassArrayFixedTask))]
            public partial RpcTask<SerializableTypeClassFixed[]> InvokeTaskFromClientSerializableClassArrayFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassArrayFixedTask))]
            public partial RpcTask<SerializableTypeClassFixed[]> InvokeTaskFromServerSerializableClassArrayFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ArraySegment<SerializableTypeClassFixed>> InvokeFromClientSerializableClassArraySegmentFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentFixed))]
            public partial RpcTask<ArraySegment<SerializableTypeClassFixed>> InvokeFromServerSerializableClassArraySegmentFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentFixedTask))]
            public partial RpcTask<ArraySegment<SerializableTypeClassFixed>> InvokeTaskFromClientSerializableClassArraySegmentFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentFixedTask))]
            public partial RpcTask<ArraySegment<SerializableTypeClassFixed>> InvokeTaskFromServerSerializableClassArraySegmentFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ICollection<SerializableTypeClassFixed>> InvokeFromClientSerializableClassICollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassICollectionFixed))]
            public partial RpcTask<ICollection<SerializableTypeClassFixed>> InvokeFromServerSerializableClassICollectionFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassICollectionFixedTask))]
            public partial RpcTask<ICollection<SerializableTypeClassFixed>> InvokeTaskFromClientSerializableClassICollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassICollectionFixedTask))]
            public partial RpcTask<ICollection<SerializableTypeClassFixed>> InvokeTaskFromServerSerializableClassICollectionFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassFixed>> InvokeFromClientSerializableClassIReadOnlyCollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionFixed))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassFixed>> InvokeFromServerSerializableClassIReadOnlyCollectionFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionFixedTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassFixed>> InvokeTaskFromClientSerializableClassIReadOnlyCollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionFixedTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassFixed>> InvokeTaskFromServerSerializableClassIReadOnlyCollectionFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IEnumerable<SerializableTypeClassFixed>> InvokeFromClientSerializableClassIEnumerableFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableFixed))]
            public partial RpcTask<IEnumerable<SerializableTypeClassFixed>> InvokeFromServerSerializableClassIEnumerableFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableFixedTask))]
            public partial RpcTask<IEnumerable<SerializableTypeClassFixed>> InvokeTaskFromClientSerializableClassIEnumerableFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableFixedTask))]
            public partial RpcTask<IEnumerable<SerializableTypeClassFixed>> InvokeTaskFromServerSerializableClassIEnumerableFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<List<SerializableTypeClassFixed>> InvokeFromClientSerializableClassListFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassListFixed))]
            public partial RpcTask<List<SerializableTypeClassFixed>> InvokeFromServerSerializableClassListFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassListFixedTask))]
            public partial RpcTask<List<SerializableTypeClassFixed>> InvokeTaskFromClientSerializableClassListFixed(int version);

            [RpcSend(nameof(ReceiveSerializableClassListFixedTask))]
            public partial RpcTask<List<SerializableTypeClassFixed>> InvokeTaskFromServerSerializableClassListFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<SerializableTypeClassVariable[]> InvokeFromClientSerializableClassArrayVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassArrayVariable))]
            public partial RpcTask<SerializableTypeClassVariable[]> InvokeFromServerSerializableClassArrayVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassArrayVariableTask))]
            public partial RpcTask<SerializableTypeClassVariable[]> InvokeTaskFromClientSerializableClassArrayVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassArrayVariableTask))]
            public partial RpcTask<SerializableTypeClassVariable[]> InvokeTaskFromServerSerializableClassArrayVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ArraySegment<SerializableTypeClassVariable>> InvokeFromClientSerializableClassArraySegmentVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentVariable))]
            public partial RpcTask<ArraySegment<SerializableTypeClassVariable>> InvokeFromServerSerializableClassArraySegmentVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentVariableTask))]
            public partial RpcTask<ArraySegment<SerializableTypeClassVariable>> InvokeTaskFromClientSerializableClassArraySegmentVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassArraySegmentVariableTask))]
            public partial RpcTask<ArraySegment<SerializableTypeClassVariable>> InvokeTaskFromServerSerializableClassArraySegmentVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ICollection<SerializableTypeClassVariable>> InvokeFromClientSerializableClassICollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassICollectionVariable))]
            public partial RpcTask<ICollection<SerializableTypeClassVariable>> InvokeFromServerSerializableClassICollectionVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassICollectionVariableTask))]
            public partial RpcTask<ICollection<SerializableTypeClassVariable>> InvokeTaskFromClientSerializableClassICollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassICollectionVariableTask))]
            public partial RpcTask<ICollection<SerializableTypeClassVariable>> InvokeTaskFromServerSerializableClassICollectionVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassVariable>> InvokeFromClientSerializableClassIReadOnlyCollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionVariable))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassVariable>> InvokeFromServerSerializableClassIReadOnlyCollectionVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionVariableTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassVariable>> InvokeTaskFromClientSerializableClassIReadOnlyCollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassIReadOnlyCollectionVariableTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeClassVariable>> InvokeTaskFromServerSerializableClassIReadOnlyCollectionVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IEnumerable<SerializableTypeClassVariable>> InvokeFromClientSerializableClassIEnumerableVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableVariable))]
            public partial RpcTask<IEnumerable<SerializableTypeClassVariable>> InvokeFromServerSerializableClassIEnumerableVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableVariableTask))]
            public partial RpcTask<IEnumerable<SerializableTypeClassVariable>> InvokeTaskFromClientSerializableClassIEnumerableVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassIEnumerableVariableTask))]
            public partial RpcTask<IEnumerable<SerializableTypeClassVariable>> InvokeTaskFromServerSerializableClassIEnumerableVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<List<SerializableTypeClassVariable>> InvokeFromClientSerializableClassListVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassListVariable))]
            public partial RpcTask<List<SerializableTypeClassVariable>> InvokeFromServerSerializableClassListVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableClassListVariableTask))]
            public partial RpcTask<List<SerializableTypeClassVariable>> InvokeTaskFromClientSerializableClassListVariable(int version);

            [RpcSend(nameof(ReceiveSerializableClassListVariableTask))]
            public partial RpcTask<List<SerializableTypeClassVariable>> InvokeTaskFromServerSerializableClassListVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<SerializableTypeStructFixed[]> InvokeFromClientSerializableStructArrayFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructArrayFixed))]
            public partial RpcTask<SerializableTypeStructFixed[]> InvokeFromServerSerializableStructArrayFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructArrayFixedTask))]
            public partial RpcTask<SerializableTypeStructFixed[]> InvokeTaskFromClientSerializableStructArrayFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructArrayFixedTask))]
            public partial RpcTask<SerializableTypeStructFixed[]> InvokeTaskFromServerSerializableStructArrayFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ArraySegment<SerializableTypeStructFixed>> InvokeFromClientSerializableStructArraySegmentFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentFixed))]
            public partial RpcTask<ArraySegment<SerializableTypeStructFixed>> InvokeFromServerSerializableStructArraySegmentFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentFixedTask))]
            public partial RpcTask<ArraySegment<SerializableTypeStructFixed>> InvokeTaskFromClientSerializableStructArraySegmentFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentFixedTask))]
            public partial RpcTask<ArraySegment<SerializableTypeStructFixed>> InvokeTaskFromServerSerializableStructArraySegmentFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ICollection<SerializableTypeStructFixed>> InvokeFromClientSerializableStructICollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructICollectionFixed))]
            public partial RpcTask<ICollection<SerializableTypeStructFixed>> InvokeFromServerSerializableStructICollectionFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructICollectionFixedTask))]
            public partial RpcTask<ICollection<SerializableTypeStructFixed>> InvokeTaskFromClientSerializableStructICollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructICollectionFixedTask))]
            public partial RpcTask<ICollection<SerializableTypeStructFixed>> InvokeTaskFromServerSerializableStructICollectionFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructFixed>> InvokeFromClientSerializableStructIReadOnlyCollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionFixed))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructFixed>> InvokeFromServerSerializableStructIReadOnlyCollectionFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionFixedTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructFixed>> InvokeTaskFromClientSerializableStructIReadOnlyCollectionFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionFixedTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructFixed>> InvokeTaskFromServerSerializableStructIReadOnlyCollectionFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IEnumerable<SerializableTypeStructFixed>> InvokeFromClientSerializableStructIEnumerableFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableFixed))]
            public partial RpcTask<IEnumerable<SerializableTypeStructFixed>> InvokeFromServerSerializableStructIEnumerableFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableFixedTask))]
            public partial RpcTask<IEnumerable<SerializableTypeStructFixed>> InvokeTaskFromClientSerializableStructIEnumerableFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableFixedTask))]
            public partial RpcTask<IEnumerable<SerializableTypeStructFixed>> InvokeTaskFromServerSerializableStructIEnumerableFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<List<SerializableTypeStructFixed>> InvokeFromClientSerializableStructListFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructListFixed))]
            public partial RpcTask<List<SerializableTypeStructFixed>> InvokeFromServerSerializableStructListFixed(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructListFixedTask))]
            public partial RpcTask<List<SerializableTypeStructFixed>> InvokeTaskFromClientSerializableStructListFixed(int version);

            [RpcSend(nameof(ReceiveSerializableStructListFixedTask))]
            public partial RpcTask<List<SerializableTypeStructFixed>> InvokeTaskFromServerSerializableStructListFixed(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<SerializableTypeStructVariable[]> InvokeFromClientSerializableStructArrayVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructArrayVariable))]
            public partial RpcTask<SerializableTypeStructVariable[]> InvokeFromServerSerializableStructArrayVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructArrayVariableTask))]
            public partial RpcTask<SerializableTypeStructVariable[]> InvokeTaskFromClientSerializableStructArrayVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructArrayVariableTask))]
            public partial RpcTask<SerializableTypeStructVariable[]> InvokeTaskFromServerSerializableStructArrayVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ArraySegment<SerializableTypeStructVariable>> InvokeFromClientSerializableStructArraySegmentVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentVariable))]
            public partial RpcTask<ArraySegment<SerializableTypeStructVariable>> InvokeFromServerSerializableStructArraySegmentVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentVariableTask))]
            public partial RpcTask<ArraySegment<SerializableTypeStructVariable>> InvokeTaskFromClientSerializableStructArraySegmentVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructArraySegmentVariableTask))]
            public partial RpcTask<ArraySegment<SerializableTypeStructVariable>> InvokeTaskFromServerSerializableStructArraySegmentVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<ICollection<SerializableTypeStructVariable>> InvokeFromClientSerializableStructICollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructICollectionVariable))]
            public partial RpcTask<ICollection<SerializableTypeStructVariable>> InvokeFromServerSerializableStructICollectionVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructICollectionVariableTask))]
            public partial RpcTask<ICollection<SerializableTypeStructVariable>> InvokeTaskFromClientSerializableStructICollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructICollectionVariableTask))]
            public partial RpcTask<ICollection<SerializableTypeStructVariable>> InvokeTaskFromServerSerializableStructICollectionVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructVariable>> InvokeFromClientSerializableStructIReadOnlyCollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionVariable))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructVariable>> InvokeFromServerSerializableStructIReadOnlyCollectionVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionVariableTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructVariable>> InvokeTaskFromClientSerializableStructIReadOnlyCollectionVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructIReadOnlyCollectionVariableTask))]
            public partial RpcTask<IReadOnlyCollection<SerializableTypeStructVariable>> InvokeTaskFromServerSerializableStructIReadOnlyCollectionVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<IEnumerable<SerializableTypeStructVariable>> InvokeFromClientSerializableStructIEnumerableVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableVariable))]
            public partial RpcTask<IEnumerable<SerializableTypeStructVariable>> InvokeFromServerSerializableStructIEnumerableVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableVariableTask))]
            public partial RpcTask<IEnumerable<SerializableTypeStructVariable>> InvokeTaskFromClientSerializableStructIEnumerableVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructIEnumerableVariableTask))]
            public partial RpcTask<IEnumerable<SerializableTypeStructVariable>> InvokeTaskFromServerSerializableStructIEnumerableVariable(int version, IModularRpcRemoteConnection connection);
            ...
            public partial RpcTask<List<SerializableTypeStructVariable>> InvokeFromClientSerializableStructListVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructListVariable))]
            public partial RpcTask<List<SerializableTypeStructVariable>> InvokeFromServerSerializableStructListVariable(int version, IModularRpcRemoteConnection connection);

            [RpcSend(nameof(ReceiveSerializableStructListVariableTask))]
            public partial RpcTask<List<SerializableTypeStructVariable>> InvokeTaskFromClientSerializableStructListVariable(int version);

            [RpcSend(nameof(ReceiveSerializableStructListVariableTask))]
            public partial RpcTask<List<SerializableTypeStructVariable>> InvokeTaskFromServerSerializableStructListVariable(int version, IModularRpcRemoteConnection connection);
