...
public class AssortedParameterInvocationTests
{
    ...
    private static readonly int[] Arg6 = [ 3, 4, 5, 6 ];
    private static readonly DateTime[] Arg7 = [ new DateTime(2022, 3, 5, 12, 11, 53, DateTimeKind.Local), new DateTime(2024, 1, 19, 1, 8, 20, DateTimeKind.Utc), new DateTime(2026, 12, 31, 23, 59, 59, DateTimeKind.Unspecified) ];
    private static readonly string[] Arg8 = [ "test string1", "test string2", null, "test string4" ];
